...
const metrics = {
    ...
    asyncGameStarts: new Counter('async_game_starts'),
    asyncGameAccepts: new Counter('async_game_accepts'),
    asyncGameDeclines: new Counter('async_game_declines'),
    asyncGameMoves: new Counter('async_game_moves'),
    asyncGameCompletes: new Counter('async_game_completes'),
    liveGameCount: new Counter('live_games'),
    liveGameLength: new Trend('live_game_duration', true),
